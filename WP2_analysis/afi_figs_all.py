...
class AfiTask(Task):
    def __init__(self, func, datadir, figsdir, duration, precip_thresh, season, method=None):
        ...
        output_path = (figsdir / 'AFI' /
                       f'{func.__code__.co_name}.{duration}.{season}.{method}.ppt_thresh_{thresh_text}.png')
