...
def main(year, month):
    target_filepath = Path(f'/gws/nopw/j04/cosmic/mmuetz/data/u-ak543/ap9.pp/precip_200501/ak543a.p9200501.europe_precip.nc')

    cmorph_datadir = Path(f'/gws/nopw/j04/cosmic/mmuetz/data/cmorph_data')
    cmorph_filepath = cmorph_datadir / f'8km-30min/precip_{year}{month:02}/cmorph_ppt_{year}{month:02}.europe.nc'
