...
if __name__ == '__main__':
    if len(sys.argv) == 3:
        forced_ascent_thresh = float(sys.argv[2])
    else:
        forced_ascent_thresh = 0.2
    # Gen setup data.
    ...
    dotplus_thresh.data = dotplus.data > forced_ascent_thresh
    ...
    dotminus_thresh.data = dotminus.data > forced_ascent_thresh
